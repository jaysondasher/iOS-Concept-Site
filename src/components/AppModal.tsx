...
const AppModal: React.FC<AppModalProps> = ({ app, onClose }) => {
    ...
    const modalContent = (
        <div className="fixed inset-0 z-[200] flex items-center justify-center pt-safe pb-safe">
            {/* Backdrop */}
            <div
            ...
            {/* Modal content */}
            <div className="relative bg-white dark:bg-gray-900 rounded-3xl shadow-2xl overflow-hidden max-w-3xl w-full max-h-[85vh] animate-scale-in m-4">
